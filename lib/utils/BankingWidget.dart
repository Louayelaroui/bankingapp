  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: widget.isStroked ? boxDecoration(
...
BoxDecoration boxDecoration({double radius = 2, Color color = Colors.transparent,  BorderRadius? borderRadius,Color? bgColor, var showShadow = false}) {
